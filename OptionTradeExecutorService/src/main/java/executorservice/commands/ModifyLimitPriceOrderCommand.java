...
public class ModifyLimitPriceOrderCommand implements ICommand<ClientOrder>{

    private final ClientOrder clientOrder;
    private final KiteConnect kiteConnect;
    private final String userId;

    public ModifyLimitPriceOrderCommand(ClientOrder clientOrder, KiteConnect kiteConnect, String userId)
    {
    ...
    public ITradeExecutionResult execute() {
        try {
            ...
            System.out.println("Updating the price for Limit order :" + clientOrder.getOrderId()+ "and order parameter: "+ getOrderParamString(orderParams));
            ...
            System.out.println("Exception while updating price "+ex+ "message :"+ message);
